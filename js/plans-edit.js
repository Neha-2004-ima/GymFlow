document.addEventListener('DOMContentLoaded', function () {
    ...
    var subtitleInput = document.getElementById('edit_subtitle');
    var priceInput = document.getElementById('edit_price');
    var featuresInput = document.getElementById('edit_features');

    if (!form) {
        console.warn('plans-edit.js: #editPlanForm not found on this page.');
        return;
    }
    ...
    form.addEventListener('submit', function (e) {
        ...
        if (!t || !s || !p || !f) {
            e.preventDefault();
            var firstErr = form.querySelector('.js-error-msg');
            if (firstErr) {
    ...
    console.log('plans-edit.js loaded OK. Form:', form.id);
});
